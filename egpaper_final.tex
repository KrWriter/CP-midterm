...
Moreover, the speed of NeRF is disastrous slow because of the hundreds of views it needs to handle.
As a result, how to use NeRF for 3D reconstruction leveraging very few images is quite important.
In the next sections, I will introduce the variants of NeRF that is able to not only reconstruct 3D scenes using sparse views and fast.
